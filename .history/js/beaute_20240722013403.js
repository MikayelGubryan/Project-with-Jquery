$(document).ready(function() {
    ...
    $('.form-list').not(this).find('.submenu-popup').slideUp(); // Hide other submenus

    // Toggle the active class and background color of the clicked item
    ...
    $(this).find('.submenu-popup').slideToggle(); // Show/hide submenu
        } else {
            $('.arrow-icon').remove();
        }
    }
